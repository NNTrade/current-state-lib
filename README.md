...
## Import
NNTrade.current_state @ git+https://git@github.com/NNTrade/current-state-lib.git#egg=NNTrade.current_state

## Using

```python
from NNTrade.common.time_frame import TimeFrame
from NNTrade.current_state import CurrentStateContainer, ChartKey
